...
// field the host rejects produces a 400 — notably GLM-5.1 on ModalResearch
...
// (#292 — confirmed live against ModalResearch's zai-org/GLM-5.1-FP8.)
const GLM_HOST_PLATFORMS = new Set<string>([
  'modalresearch', // zai-org/GLM-5.1-FP8
 ...
 *  Confirmed live against ModalResearch GLM-5.1-FP8. (#292) */
